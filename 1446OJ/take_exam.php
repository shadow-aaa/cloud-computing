...
<body onload="startCountdown('<?php echo $end_time; ?>')">
    ...
    <form action="submit_exam.php" method="POST">
        ...
        <div class="question">
            ...
            <label><input type="checkbox" name="answers[<?php echo $question['question_id']; ?>][]" value="A">
                A</label><br>
            <label><input type="checkbox" name="answers[<?php echo $question['question_id']; ?>][]" value="B">
                B</label><br>
            <label><input type="checkbox" name="answers[<?php echo $question['question_id']; ?>][]" value="C">
                C</label><br>
            <label><input type="checkbox" name="answers[<?php echo $question['question_id']; ?>][]" value="D">
                D</label><br>
            ...
            <label><input type="radio" name="answers[<?php echo $question['question_id']; ?>]" value="true">
                正确</label><br>
            <label><input type="radio" name="answers[<?php echo $question['question_id']; ?>]" value="false">
                错误</label><br>
